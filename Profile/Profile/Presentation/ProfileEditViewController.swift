...
class ProfileEditViewController: UIViewController {
  ...
  private func setupForm(for textField: UITextField) {
    ...
    switch textField {
    case nameTextField:
      button.addTarget(self, action: #selector(self.showNameAlert(_:)), for: .touchUpInside)
    case websiteTextField:
      button.addTarget(self, action: #selector(self.showWebsiteAlert(_:)), for: .touchUpInside)
    default:
  ...
  @objc func showNameAlert(_ sender: Any) {
  ...
  @objc func showWebsiteAlert(_ sender: Any) {
    let alertController = UIAlertController(
      title: "warning_info".localized(),
